...
async function sendToLovable(callSid) {
  ...
  if (
    ...
    console.log(
      "Lovable Webhook nicht konfiguriert."
    );
    return;
  }
...
<Response>
  ...
  >
    ...
    >
      ...
      Zum Beispiel:
      null sieben neun vier zwei fünf
      null null zwei drei.
    </Say>
...
<Response>
  ...
  >
    ...
    verwenden wir wenn möglich
    die angezeigte Anrufernummer.
  </Say>
...
<Response>
  ...
  <Gather
    ...
    language="de-CH"
    speechTimeout="auto"
    action="/confirm-phone?phone=${phoneDigits}"
    method="POST"
  >
  ...
  async (req, res) => {
    ...
    if (
      ...
      callSessions[
        ...
        `Telefon bestätigt: ${confirmation}`
      );
