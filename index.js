...
app.post("/speech", async (req, res) => {
  ...
  try {
    const raw =
      await analyzeWithOpenAI(speechText);
    ...
    aiResult = {
      emergency: false,
      reply:
        "Vielen Dank. Ich habe Ihr Anliegen erfasst.",
    };
  }
...
<Response>
  ...
  >
    <Say language="de-DE" voice="Polly.Vicki">
      Bitte sagen Sie mir noch Ihren Namen und Ihre Telefonnummer für den Rückruf.
    </Say>
  </Gather>

  <Say language="de-DE" voice="Polly.Vicki">
    Ich habe leider keine Angaben erhalten. Bitte rufen Sie nochmals an.
  </Say>
...
<Response>
  <Say language="de-DE" voice="Polly.Vicki">
    Vielen Dank. Ich habe Ihre Angaben aufgenommen.
